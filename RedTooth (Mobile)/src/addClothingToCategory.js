	...
	return {
		...
		contents: [
			new Column( { left: 10, right: 10, top: 10, bottom: 10, skin: borderWhiteSkin, contents: [ 
     			new Picture( {left:2, right:2, top:5, bottom: 0, width: 100, height: 100, name: 'picture', url: $.photo,}),
     			new Container({ left: 2, right: 2, top: 0, bottom: 2, skin:whiteSkin, contents: [
